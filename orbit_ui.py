...
TRANSLATIONS = {
    "ru": {
        ...
        "guide_title": "Добро пожаловать в Orbit",
        "guide_sub": "Коротко покажем основные режимы и настройки.", "site_theming": "Оформлять сайты в стиле Orbit",
    ...
    "en": {
        ...
        "guide_title": "Welcome to Orbit",
        "guide_sub": "A quick guide to the main modes and settings.", "site_theming": "Apply Orbit style to websites",
    ...
    "de": {
        ...
        "guide_title": "Willkommen bei Orbit",
        "guide_sub": "Ein kurzer Überblick über Modi und Einstellungen.", "site_theming": "Orbit-Stil für Webseiten",
    ...
    "es": {
        ...
        "guide_title": "Bienvenido a Orbit",
        "guide_sub": "Una guía rápida de modos y ajustes.", "site_theming": "Estilo Orbit en sitios",
